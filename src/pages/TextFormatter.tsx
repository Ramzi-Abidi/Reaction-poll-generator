    ...
    <section className="text-formatter">
      ...
      <div className="text-formatter-container">
        <div className="text-formatter-content">
          ...
          <TextArea textAreaValue={textAreaValue} handleChange={handleChange} />

          <div className="output">
            <div className="output-textarea">
              <p className="output-textarea-title">Bold:</p>
              <p className="result-text">{boldText(textAreaValue)}</p>
              <div className="tooltip">
                <button
                  ...
                  onMouseOut={() => outFunc()}
                >
                  <span className="tooltiptext" id="boldMyTooltip">
                    Copy to clipboard
                  </span>
                  Copy text
                </button>
            ...
            <div className="output-textarea">
              ...
              <p className="result-text">{boldSansText(textAreaValue)}</p>
              <div className="tooltip">
                <button
                  className="btn"
                  ...
                  onMouseOut={() => outFunc()}
                >
                  <span className="tooltiptext" id="boldSansMyTooltip">
                    Copy to clipboard
                  </span>
                  Copy text
                </button>
          ...
          <div className="output">
            <div className="output-textarea">
              ...
              <p className="result-text">{italicizeText(textAreaValue)}</p>
              <div className="tooltip">
                <button
                  className="btn"
                  ...
                  onMouseOut={() => outFunc()}
                >
                  <span className="tooltiptext" id="italicMyTooltip">
                    Copy to clipboard
                  </span>
                  Copy text
                </button>
            ...
            <div className="output-textarea">
              <p className="output-textarea-title">Italic sans:</p>
              <p className="result-text">{italicizeSansText(textAreaValue)}</p>
              <div className="tooltip">
                <button
                  className="btn"
                  onClick={() => handleCopyText("italicize-sans")}
                  onMouseOut={() => outFunc()}
                >
                  <span className="tooltiptext" id="italicSansMyTooltip">
                    Copy to clipboard
                  </span>
                  Copy text
                </button>
          ...
          <div className="output">
            <div className="output-textarea">
              <p className="output-textarea-title">Bold italic:</p>
              <p className="result-text">{boldUnderlineText(textAreaValue)}</p>
              <div className="tooltip">
                <button
                  className="btn"
                  onClick={() => handleCopyText("bold-underline")}
                  onMouseOut={() => outFunc()}
                >
                  <span className="tooltiptext" id="boldUnderlineMyTooltip">
                    Copy to clipboard
                  </span>
                  Copy text
                </button>
            ...
            <div className="output-textarea">
              <p className="output-textarea-title">Bold Strikethrough:</p>
              <p className="result-text">{lineThroughText(textAreaValue)}</p>
              <div className="tooltip">
                <button
                  className="btn"
                  onClick={() => handleCopyText("line-through")}
                  onMouseOut={() => outFunc()}
                >
                  <span className="tooltiptext" id="lineThroughMyTooltip">
                    Copy to clipboard
                  </span>
                  Copy text
                </button>
          ...
          <div className="output">
            <div className="output-textarea">
              <p className="output-textarea-title">Circled text:</p>
              <p className="result-text">{circledText(textAreaValue)}</p>
              <div className="tooltip">
                <button
                  className="btn"
                  ...
                  onMouseOut={() => outFunc()}
                >
                  <span className="tooltiptext" id="circledMyTooltip">
                    Copy to clipboard
                  </span>
                  Copy text
                </button>
            ...
            <div className="output-textarea">
              <p className="output-textarea-title">Circle negative text:</p>
              ...
              <div className="tooltip">
                <button
                  className="btn"
                  onClick={() => handleCopyText("circled-negative")}
                  onMouseOut={() => outFunc()}
                >

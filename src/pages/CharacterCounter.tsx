...
const CharacterCounter = () => {
  ...
  const [remainingCharacters, setRemainingCharacters] = useState<number>(3000);
    ...
    <section className="characters-counter">
      <div className="container">
        <div className="intro">
          ...
          <p>
            Use this free tool to check character count in your LinkedIn post,{" "}
            <br /> about section, or message exactly as it will appear on
            LinkedIn.
          </p>
        </div>
          ...
          <div className="characters-counter-content">
            <div className="left-part">
              <div className="first">
                <div className="characters">
                  ...
                  <span
                    style={{
                      color: typedCharacters > 3000 ? "red" : "",
                    }}
                  >
                ...
                <div className="characters">
                  ...
                  <span
                    style={{
                      color: remainingCharacters < 0 ? "red" : "",
                    }}
                  >
                    {remainingCharacters}
                  </span>
            ...
            <div className="right-part">
              ...
              <div>
                ...
                <span
                  style={{
                    color: typedCharacters > 2600 ? "red" : "",
                  }}
                >

  ...
  return (
    <section>
          ...
          <div className="icons like">
            ...
            <div>
              <input
                ...
                onChange={(e) => handleIconChange("likeState", e.target.value)}
          ...
          <div className="icons love">
            ...
            <div>
              <input
                ...
                onChange={(e) => handleIconChange("loveState", e.target.value)}
          ...
          <div className="icons insight">
            ...
            <div>
              <input
                ...
                onChange={(e) =>
                  handleIconChange("insightState", e.target.value)
                }
          ...
          <div className="icons support">
            ...
            <div>
              <input
                ...
                onChange={(e) =>
                  handleIconChange("supportState", e.target.value)
                }
          ...
          <div className="icons curious">
            ...
            <div>
              <input
                ...
                onChange={(e) =>
                  handleIconChange("curiousState", e.target.value)
                }
      ...
      <form
        ...
        onSubmit={(event: FormEvent<HTMLFormElement>) => handleDownload(event)}
      >
